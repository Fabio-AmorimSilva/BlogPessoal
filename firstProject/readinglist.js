...
let classics = ["Conde de Monte Cristo", "Grande Sertão Veredas", "Graça Infinita", "Robinson Crusoé"];
let fiction  = ["Um Conto de Duas Cidades", "O Guia do Mochileiro das Galáxias", "Viagens de Gulliver", 
"Um Conto de Natal"];
let nonfiction = ["Por de trás da Mascára", "Jardim das Aflições", "Nova Era e Revolução Cultural"];
let fantasy = ["A Batalha do Apocalipse", "Sherlock Holmes", "Senhor dos Anéis"];
...
function booksCreate(){
    ...
    genre.textContent = booksList.value.slice(0,1).toUpperCase() + 
